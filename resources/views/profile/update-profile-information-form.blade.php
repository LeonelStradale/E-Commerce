    ...
    <x-slot name="form">
        ...
        <div class="col-span-6 sm:col-span-4">
            <div class="flex items-center space-x-2">
                <x-select wire:model="state.document_type">
                ...
                <x-input type="text" class="block w-full" wire:model="state.document_number" required
                    autocomplete="document_number" placeholder="Clave de documento" />
            </div>
        </div>
