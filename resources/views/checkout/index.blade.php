                ...
                <div class="col-span-1">
                    <div class="lg:max-w-[40rem] py-12 lg:pl-8 sm:pr-6 lg:pr-8 mr-auto">
                        ...
                        <form action="{{ route('paypal') }}" method="post">
                            @csrf
                            <button type="submit"
                                class="w-full text-gray-900 bg-[#F7BE38] hover:bg-[#F7BE38]/90 focus:ring-4 focus:outline-none focus:ring-[#F7BE38]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center flex justify-center items-center dark:focus:ring-[#F7BE38]/50 me-2 mb-2">
                        ...
                        <form action="{{ route('stripe') }}" method="post">
                            @csrf
                            <button type="submit"
                                class="w-full text-white bg-[#050708] hover:bg-[#050708]/80 focus:ring-4 focus:outline-none focus:ring-[#050708]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center flex justify-center items-center dark:focus:ring-[#2557D6]/50 me-2 mb-2">
                                ...
                                <svg aria-hidden="true" class="h-4 me-2 -ms-1 w-7" viewBox="0 0 601 360" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
